                                ...
                                <form class="user" action="AddLicencieController.php" method="POST">
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input class="form-control form-control-user" type="text" name="numero_licence" required placeholder="Numéro du licencié"><br>
                                        </div>
                                        <div class="col-sm-6">
                                            <input class="form-control form-control-user" type="text" name="nom" required placeholder="Nom"><br>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input class="form-control form-control-user" type="text" name="prenom" required placeholder="Prenom"><br>
